...
// Maps old App\Services\Ontology\Parsers\RdfParser to the new
// Youri\vandenBogert\Software\ParserRdf\RdfParser class.
...
spl_autoload_register(function (string $class): void {
    ...
    $aliases = [
        'App\Services\Ontology\Parsers\RdfParser' => \Youri\vandenBogert\Software\ParserRdf\RdfParser::class,
    ];
